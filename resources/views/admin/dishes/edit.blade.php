...
@section('content')
    <form action="{{ route('admin.dishes.update', ['dish' => $dish->id]) }}" method="POST" enctype="multipart/form-data" class="card">
        @csrf
        @method('PUT')
        <div class="fs-2 text-center">MODIFICA PIATTO</div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="inputColor form-control @error('name') is-invalid @enderror " id="name" name="name"
        ...
        <div class="mb-3">
            ...
            <input type="number" min='0.00' max='9999.99' step='0.01' class="inputColor form-control @error('price') is-invalid @enderror " id="price" name="price"
        ...
        <div class="mb-3">
            ...
            <textarea class="inputColor form-control @error('description') is-invalid @enderror" id="description" name="description">{{ old('description', $dish->description) }}</textarea>
            @error('description')
                <div class="invalid-feedback">
                    <div class="alert alert-danger">{{ $message }}</div>
                </div>
